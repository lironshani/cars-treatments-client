          ...
          <div id="About">
            <div className="col login-left">
              ...
              >
                ...
                <a id="myAnswer" href="mailto:nimnimaor@gmail.com">
                  nimnimaor@gmail.com
                </a>
                <p id="subTitle">Website</p>
                <a id="myAnswer" href="https://www.w3schools.com/">
                  Visit W3Schools.com!
                </a>
                <div className="App">
                ...
                <div className="row">
                  <button
                    className="login-btn facebook-login-btn"
                    onClick={(e) => {
                      e.preventDefault();
                ...
                <div className="row">
                  <button
                    className="login-btn Twitter-login-btn"
                    onClick={(e) => {
                      e.preventDefault();
                ...
                <div className="row">
                  <button
                    className="login-btn Telegram-login-btn"
                    onClick={(e) => {
                      e.preventDefault();
